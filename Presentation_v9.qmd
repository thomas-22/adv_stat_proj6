...
:::::: columns
::: {.column width="33%"}
<img src="Figures/XGBoost_PredVSActual_last.jpg" width="500"/>
:::

::: {.column width="33%"}
<img src="Figures/XGBoost_PredVSActual_nearest.jpg" width="500"/>
:::

::: {.column width="34%"}
<img src="Figures/XGBoost_PredVSActual_score.jpg" width="500"/>
:::
::::::
...
\eta_{ij} &=& \beta_0 + \\
&& \beta_1 \cdot \textup{number of other relevant hunting events}_{ij} + \\
&& f_1(\textup{time difference}_{ij}) + f_2(\textup{distance}_{ij}) + \\
&& f_3(\textup{sample delay}_{ij}) + f_4(\textup{defecation day}_{ij}) + \\
&& \gamma_{i}, \\
\gamma_i &\overset{\mathrm{iid}}{\sim}& \mathcal{N}(0, \sigma_\gamma^2) \quad\text{for} i = 1,\dots,N
\end{eqnarray}
$$
