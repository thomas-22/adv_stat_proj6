...
ggsave("Figures/p_L_reml.png", p_L, width = 12, height = 6, dpi = 300)
...
p_N <- p_N_TimeDiff + p_N_Distance + p_N_SampleDelay +
  plot_layout(ncol = 3, axis_titles = "collect")
ggsave("Figures/p_N_reml.png", p_N, width = 12, height = 6, dpi = 300)
...
ggsave("Figures/p_S_diagnostic_reml.png", p_S_diagnostic, width = 7, height = 7, dpi = 300)
